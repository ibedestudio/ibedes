...
<figure class="max-w-xl mx-auto my-8">
  <img
    src="https://images.pexels.com/photos/9127595/pexels-photo-9127595.jpeg"
    alt="seorang ayah menatap senja dengan pikiran berat"
    class="w-full rounded-lg shadow-md"
    loading="lazy"
  />
  <figcaption class="mt-3 text-center text-sm text-zag-dark/70 dark:text-zag-light/70">
    Foto oleh <b>Timur Weber</b> di pexel
  </figcaption>
</figure>
