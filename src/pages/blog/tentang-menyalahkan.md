...
<figure class="max-w-xl mx-auto my-8">
  <img
    src="https://images.unsplash.com/photo-1502663656924-a7163d645e0c?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1470"
    alt="menyalahkan"
    class="w-full rounded-lg shadow-md"
    loading="lazy"
  />
  <figcaption class="mt-3 text-center text-sm text-zag-dark/70 dark:text-zag-light/70">
    Foto oleh <b>Adi Goldstein</b> di Unsplash
  </figcaption>
</figure>
